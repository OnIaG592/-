...
namespace Абстракция
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Aspirant aspirant = new Aspirant("Hajiyev",4,4,phdDefence);
            Student student = new Student("Haciyev",5,5);
            Console.WriteLine(student.ToString());
            Console.WriteLine( String.IsNullOrEmpty(surname));
            Console.WriteLine( student.surname.GetHashCode());
            Console.WriteLine( aspirant.surname.GetHashCode());
            Console.WriteLine(student.GetType());
            bool st1asp2 = student.Equals(aspirant);
            Console.WriteLine(st1asp2);
            Console.ReadKey();
        }
